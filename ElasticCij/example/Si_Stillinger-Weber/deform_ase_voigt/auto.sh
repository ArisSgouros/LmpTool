...
# run deform script (voigt notation)
python ../../../src/deform.py --data_in in.data --prefix_out o.pos --epsilon "$epsilon,-$epsilon" --components 1,2,3,4,5,6
...
python ../../../src/press2cij.py --prefix_in $prefix_in --prefix_out "o.press2cij" --epsilon "$epsilon,-$epsilon" --components "1,2,3,4,5,6" > o.log_press2cij
